...
<html>
	<head>
		...
		<link rel="shortcut icon" href = "img\asteri.jpg">
	</head>
	...
	<body>
		...
		<div class="well container" style="height:200px;">
			<div class="panel panel-default">
				...
				<?php
				// echo '<a href="edit_user.php.php?email='.$_GET['email'].'"</a>';
				// echo '<a href="delete_user.php.php?email='.$email'].'"</a>';
				echo '<a href="edit_user.php?email='.$email.'">(Edit)</a>';
				echo '<a href="delete_user.php?email='.$email.'">(Delete)</a>';
		...
		$sql1 = "SELECT * FROM spots WHERE user_id=:user_id LIMIT :page, 3;";
		$query1 = $db->prepare( $sql1 );
		$query1->bindParam(':user_id', $id, PDO::PARAM_INT);
	...
	$query2->bindParam(':user_id', $id, PDO::PARAM_INT);
	$query2->execute();
