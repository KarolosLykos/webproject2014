...
<html>
	<head>
		...
		href = "C:\MAMP\htdocs\karolos\img\asteri.jpg">		
...
<form action="upload_file_submit.php" enctype="multipart/form-data" method="post">
<input type="hidden" name="spotid" value="<?php echo $_GET['id'];?>">
<div class="form-group col-md-4">
<label for="inputUpload"> </label>
<input type= "file" class="form-control" id="inputUpload" name="uploadedimage" placeholder="uploadedimage" accept="image/*" capture="camera" />
</div>
<div class="form-group col-md-4">
<label for="inputNow"> </label>
<input type="submit" class="form-control" id="inputNow"  placeholder="Upload Now" >
</div>
